    ...
    <div className="min-h-screen flex flex-col items-center pt-8 px-6 pb-4" style={{ background: 'linear-gradient(to bottom, #FFF8F0 10%, #FFD6E8 70%, #E0D4FF 110%)' }}>
      <div className="w-full flex flex-col items-center">
        ...
        <div className="flex-1 flex flex-col items-center justify-center mt-16 mb-8">
          <div className="rounded-3xl p-10 py-12 shadow-lg shadow-[#FFB5D8]/20 mb-8 max-w-md" style={{ backgroundColor: 'rgba(255, 181, 216, 0.2)' }}>
          ...
          <Button
            onClick={onStart}
            className="w-[90%] max-w-md py-6 rounded-2xl text-white shadow-lg shadow-[#FFB5D8]/30 transition-all text-base hover:opacity-90"
            style={{ backgroundColor: 'rgba(255, 181, 216, 0.3)' }}
          >
